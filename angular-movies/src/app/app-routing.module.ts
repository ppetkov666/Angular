...
const routes: Routes = [
  ...
  { path: 'movietheater', component: IndexMovieTheaterComponent, canActivate: [IsAdminGuard] },
  { path: 'movietheater/create', component: CreateMovieTheaterComponent, canActivate: [IsAdminGuard] },
  { path: 'movietheater/edit/:id', component: EditMovieTheaterComponent, canActivate: [IsAdminGuard] },
